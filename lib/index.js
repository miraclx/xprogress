        ...
        .on('progress', progress => {
          ...
          (actor || ((_bar, args, template) => _bar.value(...args).draw(template)))(
            ...
            bar.opts.progress.infinite ? [progress.delta + bar.average().completed] : [slotIndex, progress.transferred],
            {
              ...
              speed: (_, unit) => `${xbytes.createRelativeSizer(unit || defaultUnit, {short: !0, space: !0, bits: !0})(xpeed)}ps`,
              'speed:raw': xpeed,
              'slot:speed': (_, unit) =>
                `${xbytes.createRelativeSizer(unit || defaultUnit, {short: !0, space: !0, bits: !0})(progress.speed)}ps`,
